...
const Navbar: React.FC = () => (
  <nav className="fixed top-0 left-0 w-full z-50 bg-main-dark/80 backdrop-blur-md border-b border-white/10">
    <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
      <a href="#" className="text-xl font-semibold tracking-[0.35em] text-vibrant-green font-serif">FIMBROW</a>
      <a
        href="#application"
        className="px-5 py-2 bg-white/90 text-main-dark font-medium text-xs tracking-wider hover:opacity-80 transition-opacity"
      >
        수강 상담 신청
      </a>
    </div>
  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center pt-16 px-6 overflow-hidden">
      ...
      <div className="relative z-10 max-w-[640px] text-center">
        {/* Eyebrow */}
        <p className="text-xs tracking-[0.38em] uppercase text-vibrant-green/80 mb-12 flex items-center justify-center gap-3">
        ...
        {/* Q&A */}
        <p className="font-serif text-lg md:text-xl text-white/60 mb-4 italic">
          잘하는 사람은 처음부터 달랐을까요?
        </p>
        <div className="w-px h-7 bg-vibrant-green/40 mx-auto mb-4"></div>
        <h1 className="font-serif text-3xl md:text-5xl font-bold italic mb-12 leading-tight">
        ...
        {/* Info */}
        <div className="border-t border-white/15 pt-8 mb-10 flex flex-col items-center gap-2">
...
const Numbers: React.FC = () => (
  <section className="py-20 px-6 bg-main-dark">
    <div className="max-w-[680px] mx-auto text-center mb-12">
      <span className="text-xs font-bold tracking-[0.35em] uppercase text-vibrant-green mb-5 inline-block">Numbers</span>
      <h2 className="font-serif text-3xl md:text-4xl font-semibold text-white">숫자로 보는 핌브로우</h2>
    </div>
    <div className="grid grid-cols-2 md:grid-cols-4 max-w-[900px] mx-auto border border-white/10">
      {[
        ...
        <div key={idx} className="py-12 px-6 text-center border-r border-b border-white/10 last:border-r-0 md:[&:nth-child(4)]:border-r-0">
          <div className="font-serif text-2xl md:text-4xl font-bold text-vibrant-green leading-none">{item.val}</div>
...
const Urgency: React.FC = () => (
  <section className="py-20 px-6 bg-[#6B1F2A] text-center">
    <span className="text-xs font-bold tracking-[0.35em] uppercase text-vibrant-green/70 mb-5 inline-block">Why Now</span>
    <h2 className="font-serif text-xl md:text-2xl font-semibold text-white mb-8 leading-snug">지금 신청해야 하는 이유</h2>
    <div className="w-7 h-px bg-vibrant-green/40 mx-auto mb-8"></div>
    <p className="font-serif text-2xl md:text-4xl font-bold text-vibrant-green italic leading-snug mb-10">
    ...
    <a href="#application" className="inline-block mt-10 px-11 py-4 bg-vibrant-green text-[#6B1F2A] font-bold text-sm tracking-wider">
      지금 상담 신청하기
    </a>
  </section>
);
...
const Problem: React.FC = () => (
  <section className="py-24 px-6 bg-[#041e1c]">
    <div className="max-w-[680px] mx-auto text-center">
      ...
      <h2 className="font-serif text-2xl md:text-4xl font-semibold text-white leading-snug">
      ...
      <p className="text-xs tracking-[0.22em] uppercase text-white/50 font-semibold mt-7 mb-2">기술 종류</p>
    ...
    <div className="max-w-[680px] mx-auto mt-10 text-center">
      <p className="font-serif text-xl md:text-3xl font-semibold italic text-white leading-relaxed">
...
const Market: React.FC = () => (
  <section className="py-24 px-6 bg-vibrant-green/10">
    <div className="max-w-[960px] mx-auto text-center">
      ...
      <h2 className="font-serif text-xl md:text-3xl font-semibold text-white leading-snug">
      ...
      <p className="font-serif text-lg md:text-2xl italic font-bold text-vibrant-green mt-8 leading-relaxed">
        "잘못된 시술 하나가 평생을 남깁니다."
      </p>
    </div>
  </section>
...
const Philosophy: React.FC = () => (
  <section className="py-24 px-6 bg-main-dark">
    <div className="max-w-[680px] mx-auto text-center">
      ...
      {/* Big quote */}
      <div className="max-w-[500px] mx-auto mb-14 text-center">
        <span className="font-serif text-5xl text-vibrant-green/40 block mb-4">&ldquo;</span>
        <div className="flex flex-col gap-4">
          <span className="font-serif text-xl md:text-2xl italic text-white/70">나도 할 수 있을까?</span>
          <span className="font-serif text-xl md:text-2xl italic text-white/70">왜 나는 안 되는 걸까?</span>
        </div>
        <span className="font-serif text-5xl text-vibrant-green/40 block mt-4">&rdquo;</span>
      </div>

      <h2 className="font-serif text-2xl md:text-4xl font-semibold text-white">그래서<br/>이 수업을 만들었습니다</h2>
      <div className="w-7 h-px bg-vibrant-green mx-auto my-6"></div>
    </div>

    {/* Philosophy card */}
    <div className="max-w-[560px] mx-auto mb-12 p-8 border border-white/10 relative">
      <span className="absolute -top-4 left-6 font-serif text-8xl text-white/5 leading-none">&ldquo;</span>
      <p className="font-serif text-lg text-white/80 leading-relaxed italic relative z-10">
        "처음부터 제대로 배웠다면<br/>이 고객은 피해자가 되지 않았을 텐데."
      </p>
      <p className="text-xs text-white/30 tracking-wider mt-6">— 12년 동안, 수없이 반복한 생각</p>
    </div>

    <div className="max-w-[560px] mx-auto text-center text-sm text-white/50 leading-relaxed space-y-4">
      <p>12년 동안 1.5만 명의 고객을 시술하며,<br/>안타까운 경우를 너무 많이 봤습니다.</p>
      <p>그래서 만들었습니다.<br/><strong className="text-white/80 font-medium">기술만 가르치는 교육이 아니라, 올바른 방향을 알려주는 교육을.</strong></p>
  ...
  <section className="py-24 px-6 bg-[#041e1c]">
    <div className="max-w-[960px] mx-auto text-center">
      ...
      <div className="w-[min(300px,78%)] mx-auto mb-10 relative">
        ...
        <img src="/profile.jpeg" alt="핌브로우 원장" className="relative w-full rounded-xl object-cover aspect-[3/4]" />
      </div>
      ...
      {/* Career 2-column */}
      <div className="max-w-[960px] mx-auto mt-10 pt-10 border-t border-white/10 grid grid-cols-2 gap-6 md:gap-10 text-left">
        <div>
...
const Results: React.FC = () => (
  <section className="py-24 px-6 bg-vibrant-green/10">
    <div className="max-w-[960px] mx-auto text-center">
      ...
      <h2 className="font-serif text-2xl md:text-4xl font-semibold text-white">15,000명 임상에서 나온 결과</h2>
      <div className="w-7 h-px bg-vibrant-green mx-auto my-6"></div>
  ...
  <section className="py-24 px-6 bg-[#041e1c]">
    <div className="max-w-[960px] mx-auto text-center">
      ...
      <h2 className="font-serif text-2xl md:text-4xl font-semibold text-white">
        왜 한 기수에 <span className="text-vibrant-green text-3xl md:text-5xl">4명만</span> 모집할까요?
      </h2>
      <p className="font-serif text-base md:text-lg italic text-vibrant-green/80 mt-4">
...
const Curriculum: React.FC = () => (
  <section id="curriculum" className="py-24 px-6 bg-main-dark">
    <div className="max-w-[680px] mx-auto text-center">
      <span className="text-xs font-bold tracking-[0.22em] text-vibrant-green mb-5 inline-block">FIMBROW STUDIO</span>
      <h2 className="font-serif text-2xl md:text-4xl font-semibold text-white">MASTER CLASS CURRICULUM</h2>
      ...
      <div className="flex justify-center gap-16 flex-wrap mb-10">
        <div className="text-center">
          ...
          <div className="text-sm text-white/50 mt-1">사전 교육</div>
        </div>
        <div className="text-center">
          <div className="font-serif text-xl font-bold text-vibrant-green">오프라인 2개월</div>
          <div className="text-sm text-white/50 mt-1">매주 화요일 7시간 (56시간)</div>
        </div>
      </div>
    </div>
...
const Materials: React.FC = () => (
  <section className="py-24 px-6 bg-[#041e1c]">
    <div className="max-w-[960px] mx-auto text-center">
      ...
      <h2 className="font-serif text-2xl md:text-4xl font-semibold text-white">수강 시 제공되는 자료</h2>
      <div className="w-7 h-px bg-vibrant-green mx-auto my-6"></div>
...
const TargetSection: React.FC = () => (
  <section className="py-24 px-6 bg-vibrant-green/10">
    <div className="max-w-[680px] mx-auto text-center">
      ...
      <h2 className="font-serif text-2xl md:text-4xl font-semibold text-white">이 수업은<br/>아무나 듣는 수업이 아닙니다.</h2>
      <div className="w-7 h-px bg-vibrant-green mx-auto my-6"></div>
...
const ReviewSlider: React.FC = () => (
  <section className="py-24 px-0 bg-main-dark overflow-hidden">
    <div className="max-w-7xl mx-auto px-6 mb-12 text-center">
      <span className="text-xs font-bold tracking-[0.35em] uppercase text-vibrant-green mb-5 inline-block">Reviews</span>
      <p className="font-serif text-2xl md:text-4xl font-semibold text-white">실제 수강생 후기</p>
    </div>
    <div className="relative">
      <div className="absolute left-0 top-0 bottom-0 w-20 bg-gradient-to-r from-main-dark to-transparent z-10 pointer-events-none"></div>
      <div className="absolute right-0 top-0 bottom-0 w-20 bg-gradient-to-l from-main-dark to-transparent z-10 pointer-events-none"></div>
...
const Pricing: React.FC = () => (
  <section className="py-24 px-6 bg-[#041e1c]">
    <div className="max-w-[960px] mx-auto text-center">
      ...
      <h2 className="font-serif text-2xl md:text-4xl font-semibold text-white">수강료 안내</h2>
      <div className="w-7 h-px bg-vibrant-green mx-auto my-6"></div>

      {/* Banner */}
      <div className="max-w-[860px] mx-auto bg-[#6B1F2A] px-6 py-5 flex flex-wrap items-center justify-center gap-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-[860px] mx-auto mt-6 text-left">
        ...
        <div className="border border-white/10">
          <div className="bg-main-dark p-8 text-center">
            <div className="text-[0.62rem] tracking-[0.28em] uppercase text-vibrant-green/50 mb-3">FIMBROW MASTER CLASS · 2026</div>
...
const ApplicationForm: React.FC = () => {
  ...
  return (
    <section id="application" className="py-24 px-6 bg-vibrant-green/10">
      <div className="max-w-[680px] mx-auto text-center mb-10">
        ...
        <h2 className="font-serif text-2xl md:text-4xl font-semibold text-white">수강 상담 신청</h2>
        <div className="w-7 h-px bg-vibrant-green mx-auto my-6"></div>
      ...
      <form onSubmit={handleSubmit} className="max-w-[640px] mx-auto bg-main-dark border border-white/10 text-left">
        ...
        <div className="p-8 space-y-5">
          ...
          <div>
            ...
            <input type="text" required placeholder="이름을 입력해 주세요" className="w-full px-3.5 py-2.5 bg-[#041e1c] border border-white/10 text-sm text-white outline-none focus:border-vibrant-green transition-colors placeholder:text-white/25" />
          </div>
          ...
          <div>
            ...
            <input type="tel" required placeholder="010-0000-0000" className="w-full px-3.5 py-2.5 bg-[#041e1c] border border-white/10 text-sm text-white outline-none focus:border-vibrant-green transition-colors placeholder:text-white/25" />
          </div>
          ...
          <div>
            ...
            <div className="ml-6 mt-2">
              <input type="text" placeholder="기타에 해당하시면 어떤 일을 하시는지 적어주세요" className="w-full px-3.5 py-2.5 bg-[#041e1c] border border-white/10 text-sm text-white outline-none focus:border-vibrant-green transition-colors placeholder:text-white/25" />
            </div>
          </div>
          ...
          <div>
            ...
            <textarea required placeholder="자유롭게 작성해 주세요" className="w-full px-3.5 py-2.5 bg-[#041e1c] border border-white/10 text-sm text-white outline-none focus:border-vibrant-green transition-colors placeholder:text-white/25 resize-y min-h-[88px]" />
          </div>
          ...
          <div>
            ...
            <input type="text" placeholder="예) 평일 오전 / 평일 오후 / 저녁 / 상관없음" className="w-full px-3.5 py-2.5 bg-[#041e1c] border border-white/10 text-sm text-white outline-none focus:border-vibrant-green transition-colors placeholder:text-white/25" />
          </div>

          {/* 기타 */}
          <div>
            <label className="block text-xs font-semibold tracking-wider uppercase text-white mb-2">궁금한 점 또는 남기고 싶은 말</label>
            <textarea placeholder="자유롭게 남겨주세요" className="w-full px-3.5 py-2.5 bg-[#041e1c] border border-white/10 text-sm text-white outline-none focus:border-vibrant-green transition-colors placeholder:text-white/25 resize-y min-h-[88px]" />
          </div>
...
const Footer: React.FC = () => (
  <footer className="py-12 px-6 bg-main-dark text-center">
